    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        if (cmd.equalsIgnoreCase("pmchatreply")) {
            ...
            if (plugin.lastPMd.get(pName) != null) {
                ...
                if (!API.checkPermissions(player.getName(), player.getWorld().getName(), "mchat.pm.reply")) {
                    player.sendMessage(formatPMessage(MessageUtil.addColour("You are not allowed to use PM reply functions.")));
                    return true;
                }
