package ca.q0r.mchat.yml.config;
...
public enum ConfigType {
    ...
    /**
     * Variable Indicator. Used in Locale.yml for Variables hardcoded into MChat or Bukkit.
     */MCHAT_VAR_INDICATOR("mchat.varIndicator"),
    /**
     * Locale Variable Indicator. Used in locale.yml for Variables used by MChat.
     */MCHAT_LOCALE_VAR_INDICATOR("mchat.localeVarIndicator"),
    /**
     * Custom Variable Indicator. Used in locale.yml for Variables added by other Pluginss.
    ...
    /**
     * Whether or not to Add New Players into <b>info.yml</b> when they join.
